...
ContentProDuctActivity extends AppCompatActivity implements GioHangView {
    ...
    private void Init() {
        ...
        txtnsx.setText(" "+sanPhamModels.getHansudung());
        txtmota.setText(" "+sanPhamModels.getMota());
        txtbaohanh.setText(" "+sanPhamModels.getTrongluong());
        txttensp.setText(" "+sanPhamModels.getTensp());
        txtgiatien.setText(" "+NumberFormat.getNumberInstance().format(sanPhamModels.getGiatien())+" VNĐ");
