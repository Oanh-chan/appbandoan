...
import com.example.appfoodv2.View.SearchActivity;
...
public class FragMent_Home  extends Fragment implements SanPhamView {
    ...
    private ImageButton imgBtnDanhMuc, imageCart, imagetatca;

    private TextView xem_them, xemthem;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        imageCart.setOnClickListener(view1 -> {
            activityCallback.GioHang();
        });
        FragMent_HomeListener fragMent_homeListener = (FragMent_HomeListener) getActivity();
        xem_them.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        imagetatca.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(getActivity(), SearchActivity.class);
                startActivity(i);
...
///Tạo banner
    ...
    private void InitWidget() {
        ...
        imageCart = view.findViewById(R.id.home_btn_cart);
        xem_them = view.findViewById(R.id.xem_them);
        imagetatca = view.findViewById(R.id.home_btn_tatca);
        xemthem = view.findViewById(R.id.test_xem_them);
